...
* **Map-independent imputation** of missing genotypes 
using Random Forest or the most frequent genotype.
...
* [Missing data visualization and analysis (html vignette)](https://www.dropbox.com/s/4zf032g6yjatj0a/vignette_missing_data_analysis.nb.html?dl=0)
Inside R:
```r
