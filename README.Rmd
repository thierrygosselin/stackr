...
Not much, tiny differences here and there (see function doc)
that speed up my workflow in R on my computer or my cluster.

**Who's it for?**
It's currently developed with my own projects in mind and to 
help collaborators to get the most out of stacks.

It's not for R or stacks beginners. stacks related issues should be highlighted on [stacks google group](https://groups.google.com/forum/?fromgroups#!forum/stacks-users).
