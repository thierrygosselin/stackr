...
Do you see patterns in your plots that provides insight about the relationships that missing values might have with other variables.

If you see a pattern, ask yourself (inspired from [r4ds](http://r4ds.had.co.nz/exploratory-data-analysis-eda.html)):
