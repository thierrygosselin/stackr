...
3. Update your `~/.R/Makevars` file, it should include these lines:
```r
...
4. Download and compile randomForestSRC, from the Terminal:
```r
cd ~/Downloads
...
5. Install and load randomForestSRC, from R console:
```r
