...
![heatmap](https://github.com/thierrygosselin/stackr/vignettes/blob/master/stickleback.missing.heatmap.png)

**The IBM-PCoA plot:**

![IBM-PCoA plot](https://github.com/thierrygosselin/stackr/vignettes/blob/master/stickleback.ibm.png)
...
**The boxplot of missing per populations:** `boxplot.missing.pop <- ibm.stickleback$missing.genotypes.ind`

![boxplot](https://github.com/thierrygosselin/stackr/vignettes/blob/master/stickleback.missing.boxplot.pop.png)

### Visualization
We will leave that for discussion, use our [wiki page](https://github.com/thierrygosselin/CIEE_missing/wiki/CIEE-Missing-data-workgroup-Wikipedia) for this!
