#' @title STACKS batch_x.haplotypes.tsv file summary.
#' @description Output a blacklist of putative paralogs and consensus loci
...
#' @title Create a list of putative paralogs.
#' @description Output putative paralogs loci.
#' @param haplotypes.file The 'batch_x.haplotypes.tsv' created by STACKS.
#' @param pop.id.start The start of your population id 
#' in the name of your individual sample.
#' @param pop.id.end The end of your population id 
