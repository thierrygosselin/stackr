...
#' @title Population sumstats filter
#' @description Filter a tidy VCF file based
#' on individual number, percentage or fix threshold.
#' @param data A data frame object or file (using ".tsv") of a tidy VCF.
#' @param population.map The population map or individuals listed in one column.
#' No headers.
#' @param pop.id.start The start of your population id 
#' in the name of your individual sample.
