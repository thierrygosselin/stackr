...
filter_het <- function(
  ...
  # Biallelic data ?
  biallelic <- stackr::detect_biallelic_markers(data = input, verbose = FALSE)

  # if (!biallelic && !tibble::has_name(input, "ALT")) {
  #   input <- stackr::ref_alt_alleles(data = input, monomorphic.out = TRUE, parallel.core = parallel.core)$input
  # }
